    ...
    return (
      <Screen>
        ...
        <ListHeader text="Notifications" />
          ...
          {!hasPhone && <ListItem icon="md-call" text="Link Phone Number" onPress={this.onLinkPhone} />}
        </List>
        <ActionSheet
          ref={(ref) => { this.editEmailActionSheet = ref; }}
        ...
        />
        <ActionSheet
          ref={(ref) => { this.editSocialActionSheet = ref; }}
